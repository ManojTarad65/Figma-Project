...
//       {/* ================= CONTENT ================= */}
//       <div className="relative z-10 h-full flex flex-col items-center pt-12 px-6">
...
//           {/* -------- NOMBRE -------- */}
//           <div>
//             <label className="block text-lg md:text-xl font-semibold mb-3">
//               Nombre
//             </label>

//             <div className="relative">
//               <User className="absolute left-6 top-1/2 -translate-y-1/2 text-red-500 w-10 h-10" />
//               <input
//                 type="text"
//                 placeholder="Ingrese nombre del alumno"
//                 className="w-full bg-gray-200 text-black
//                            rounded-full border-4 border-black
//                            pl-16 pr-6 py-4 md:py-5
//                            text-lg md:text-2xl
//                            placeholder:text-gray-400 text-light
//                            focus:outline-none"
//               />
//             </div>
//           </div>
...
//         <div className="hidden md:flex absolute right-16 top-20 
