...
export default function Hero() {
  return (
    <section className="relative w-screen h-[100dvh] overflow-hidden bg-black text-white font-montserrat">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-red-600/57 backdrop-brightness-98" />
      </div>
      ...
      <div className="relative z-10 h-full w-full flex flex-col overflow-hidden">
        ...
        <div className="hidden md:flex absolute right-24 top-10 
