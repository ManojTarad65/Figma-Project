...
export default function Navbar() {
  return (
    <header className="w-full bg-white text-black relative z-50 overflow-hidden">

      {/* Main Navbar Container */}
      <div className="max-w-[1920px] mx-auto px-24 py-4 flex items-center justify-between">

        {/* LEFT: Logo */}
        <div className="flex-shrink-0">
          <div className="relative h-[65px] w-[160px]">
            <Image
              src="/logo.png"
              alt="Neuro Diversión Logo"
              fill
        ...
        <nav className="hidden xl:flex items-center justify-center gap-22 text-center">

          <a className="font-montserrat font-bold text-[16px] leading-tight uppercase tracking-[0.02em]">
            PLANES DE <br /> SUSCRIPCIÓN
          </a>

          <a className="font-montserrat font-bold text-[16px] leading-tight uppercase tracking-[0.02em]">
            CONTACTA A <br /> UN PROFESIONAL
          </a>

          <a className="font-montserrat font-bold text-[16px] uppercase tracking-[0.02em]">
            NOSOTROS
          </a>
      ...
      {/* 3-Color Strip */}
      <div className="w-full h-[10px] bg-gradient-to-r from-[#E11B22] via-[#FFCC00] to-[#80C342]" />
